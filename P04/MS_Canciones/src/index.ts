...
const bootstrapServer = async () => {
    ...
    app.listen(PORT_APP_MS_CANCIONES, () => {
        console.log(`Microservicio Cancion en http://localhost:${PORT_APP_MS_CANCIONES}`);
        console.log(`Microservicio Cancion GraphQL en http://localhost:${PORT_APP_MS_CANCIONES}/graphql`);
    })
}
