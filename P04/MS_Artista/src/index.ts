...
const bootstrapServer = async () => {
    ...
    app.listen(PORT_APP_MS_ARTISTA, () => {
        console.log(`Micoservicio Artista en http://localhost:${PORT_APP_MS_ARTISTA}`);
        console.log(`Micoservicio Artista GraphQL en http://localhost:${PORT_APP_MS_ARTISTA}/graphql`);
    })
}
