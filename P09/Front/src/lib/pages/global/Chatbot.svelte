<script>
    ...
    const sendMessage = async () => {
        ...
        try {
            ...
            messages = [...messages, { message: response.data ? response.data : response.message, sender: 'bot' }];
    ...
    const fetchBotResponse = async (message) => { 
        try {
            const response = await fetch(`${pathChatbotMS}/deep`, {
                method: 'POST',
                headers: {
